        ...
        >
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto">
              <Button className="w-full sm:w-auto bg-[#004aad] hover:bg-[#003a87] text-white text-base sm:text-lg py-2.5 sm:py-3 md:py-4 px-4 sm:px-6 md:px-8 rounded-lg sm:rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-blue-200/50 transition-all duration-300 hover:translate-y-[-2px]">
                Get Started{" "}
